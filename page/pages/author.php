...
$books_per_page = 10;
$number_of_books = GetNumberOfAuthorsBooks($author);
$number_of_pages = ceil($number_of_books / $books_per_page);
$books = GetAuthorsBooks($author, $page, $books_per_page);
?>
            ...
            <li class="page-item">
                <a class="page-link <?php if ($page == 1)
                    echo 'disabled'; ?>" <?php if ($page == 1)
                          echo 'tabindex="-1"'; ?>
                    href="/authors/<?php echo urlencode($author); ?>/<?php echo $page - 1; ?>" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <?php if ($page - 2 > 0) { ?>
                <li class="page-item"><a class="page-link"
                        href="/authors/<?php echo urlencode($author); ?>/<?php echo $page - 2; ?>"><?php echo $page - 2; ?></a></li>
            <?php } ?>
            <?php if ($page - 1 > 0) { ?>
                <li class="page-item"><a class="page-link"
                        href="/authors/<?php echo urlencode($author); ?>/<?php echo $page - 1; ?>"><?php echo $page - 1; ?></a></li>
            <?php } ?>
            ...
            <li class="page-item">
                <a class="page-link <?php if ($page == $number_of_pages)
                    echo 'disabled'; ?>" <?php if ($page == $number_of_pages)
                          echo 'tabindex="-1"'; ?>
                    href="/authors/<?php echo urlencode($author); ?>/<?php echo $page + 1; ?>" aria-label="Next">
