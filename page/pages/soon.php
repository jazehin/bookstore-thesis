...
$sqlnum =  "SELECT isbn FROM not_yet_published";
...
<h2 class="fs-3">Nemsokára megjelenik</h2>
            ...
            <div class="row position-relative">
                ...
                <div class="col-lg col-12">
                    <div class="bookcard-content">
                        ...
                        <span class="bookcard-release-date">
                            <?php $date_of_release = date_format(date_create($bookdata["date_published"]), "Y. m. d."); ?>
                            <?php echo "Várható kiadás dátuma: $date_of_release"; ?>
                        </span>
                    </div>
                </div>
        ...
        <li class="page-item">
            <a class="page-link <?php if ($page == 1)
                echo 'disabled'; ?>" <?php if ($page == 1)
                      echo 'tabindex="-1"'; ?>
                href="/soon/<?php echo $page - 1; ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
            </a>
        </li>
        <?php if ($page - 2 > 0) { ?>
            <li class="page-item"><a class="page-link"
                    href="/soon/<?php echo $page - 2; ?>"><?php echo $page - 2; ?></a></li>
        <?php } ?>
        <?php if ($page - 1 > 0) { ?>
            <li class="page-item"><a class="page-link"
                    href="/soon/<?php echo $page - 1; ?>"><?php echo $page - 1; ?></a></li>
        <?php } ?>
        ...
        <li class="page-item">
            <a class="page-link <?php if ($page == $number_of_pages)
                echo 'disabled'; ?>" <?php if ($page == $number_of_pages)
                      echo 'tabindex="-1"'; ?>
                href="/soon/<?php echo $page + 1; ?>" aria-label="Next">
