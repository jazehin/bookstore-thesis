...
$sqlnum =  "SELECT isbn FROM bestsellers";
        ...
        <li class="page-item">
            <a class="page-link <?php if ($page == 1)
                echo 'disabled'; ?>" <?php if ($page == 1)
                      echo 'tabindex="-1"'; ?>
                href="/bestsellers/<?php echo $page - 1; ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
            </a>
        </li>
        <?php if ($page - 2 > 0) { ?>
            <li class="page-item"><a class="page-link"
                    href="/bestsellers/<?php echo $page - 2; ?>"><?php echo $page - 2; ?></a></li>
        <?php } ?>
        <?php if ($page - 1 > 0) { ?>
            <li class="page-item"><a class="page-link"
                    href="/bestsellers/<?php echo $page - 1; ?>"><?php echo $page - 1; ?></a></li>
        <?php } ?>
        ...
        <li class="page-item">
            <a class="page-link <?php if ($page == $number_of_pages)
                echo 'disabled'; ?>" <?php if ($page == $number_of_pages)
                      echo 'tabindex="-1"'; ?>
                href="/bestsellers/<?php echo $page + 1; ?>" aria-label="Next">
